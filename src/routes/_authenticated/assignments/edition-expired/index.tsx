          ...
          <div className="max-w-4xl mx-auto px-6 py-12">
            ...
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
                Dossiers en Édition Expirée
              </h1>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                Cette fonctionnalité est actuellement en cours de développement pour vous offrir une meilleure gestion des dossiers en édition expirée.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button 
                ...
                className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-3 rounded-lg transition-all duration-300"
              >
