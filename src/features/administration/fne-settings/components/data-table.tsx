...
export function DataTable({ onView, onEdit, onDelete, onEnable, onDisable }: DataTableProps) {
  const { fneSettings, loading, error, fetchFNESettings } = useFNESettingsStore()
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-muted-foreground">Chargement des paramètres FNE...</p>
        </div>
      </div>
    )
  }
