...
export function DataTable({ onView, onEdit, onDelete }: DataTableProps) {
  const { generalStates, loading, error, fetchGeneralStates } = useGeneralStatesStore()
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-muted-foreground">Chargement des états généraux...</p>
        </div>
      </div>
    )
  }
