...
export function DataTable({ onView, onEdit, onDelete, onEnable, onDisable }: DataTableProps) {
  const { generalStatusDeadlines, loading, error, fetchGeneralStatusDeadlines } = useGeneralStatusDeadlinesStore()
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-muted-foreground">Chargement des délais de statuts généraux...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <Button 
            onClick={fetchGeneralStatusDeadlines}
            variant="outline"
            className="mt-4"
          >
            Réessayer
          ...
          <TableBody>
            {table.getRowModel().rows?.length ? (
              ...
              <TableRow>
                ...
                >
                  Aucun délai de statut général trouvé.
                </TableCell>
              </TableRow>
            )}
          </TableBody>
