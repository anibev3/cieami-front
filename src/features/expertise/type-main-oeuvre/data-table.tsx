...
interface DataTableProps {
  data: WorkforceType[]
  onView: (workforceType: WorkforceType) => void
  onEdit: (workforceType: WorkforceType) => void
  onDelete: (workforceType: WorkforceType) => void
}
...
export function DataTable({ data, onView, onEdit, onDelete }: DataTableProps) {
  ...
  const columns: ColumnDef<WorkforceType>[] = useMemo(
    () => [
      {
        accessorKey: 'id',
        header: 'ID',
      ...
      },
      {
        ...
        enableHiding: false,
        cell: ({ row }) => {
          const workforceType = row.original
          ...
          return (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuCheckboxItem
                  onClick={() => onDelete(workforceType)}
