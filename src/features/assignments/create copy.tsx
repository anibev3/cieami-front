...
//                         section.id === 2 ?
//                         (form.watch('assignment_type_id') && form.watch('expertise_type_id') && form.watch('document_transmitted_id')) :
//                         section.id === 3 ?
...
//                   </CardTitle>
//                   <CardDescription>
//                     Informations de base sur le dossier et les parties impliquées
//                   </CardDescription>
//                 </CardHeader>
