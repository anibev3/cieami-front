...
interface DataTableProps {
  data: HourlyRate[]
  onView: (hourlyRate: HourlyRate) => void
  onEdit: (hourlyRate: HourlyRate) => void
  onDelete: (hourlyRate: HourlyRate) => void
}
...
export function DataTable({ data, onView, onEdit, onDelete }: DataTableProps) {
  ...
  const columns: ColumnDef<HourlyRate>[] = useMemo(
    () => [
      {
        accessorKey: 'id',
        header: 'ID',
