...
interface DataTableProps {
  data: Bodywork[]
  onView: (bodywork: Bodywork) => void
  onEdit: (bodywork: Bodywork) => void
  onDelete: (bodywork: Bodywork) => void
}
...
export function DataTable({ data, onView, onEdit, onDelete }: DataTableProps) {
  ...
  const columns: ColumnDef<Bodywork>[] = useMemo(
    () => [
      {
        accessorKey: 'id',
        header: 'ID',
